                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">학사일정 수정</h3></div>
                                    <div class="card-body">
                                        <form name="registerfrm" method="post" action="<c:url value='/admin/campusInfo/edit_post'/>">
                                            <input type="hidden" name="calNo" value="${param.calNo }">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="contents" id="contents" type="text" 
                                                	value="${map['CONTENTS'] }" placeholder="Enter your first name" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" type='date' name='sDate' id='sDate' 
                                                        	value="${fn:substring(map['SDATE'],0,10) }" placeholder="시작일자"/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" type='date' name='eDate' id='eDate' 
                                                        	value="${fn:substring(map['EDATE'],0,10) }" placeholder="종료일자"/>
