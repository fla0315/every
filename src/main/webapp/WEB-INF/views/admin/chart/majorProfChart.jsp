...
<main>
	<div class="container-fluid px-4">
		...
		<form name="searchfrm" method="get" action="<c:url value='/admin/chart/selectProfMajor'/>">
		...
		<div style="clear: both">
			<div class="col-xl-6" style="width: 650px; float: left">
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-chart-bar me-1" style="font-size: 1.3em"></i> 직책별 교수 수
					</div>
			...
			<div class="col-xl-6" style="width: 550px; float: left; margin-left: 20px">
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-chart-bar me-1" style="font-size: 1.3em"></i> 직책별 교수 비중
					</div>
