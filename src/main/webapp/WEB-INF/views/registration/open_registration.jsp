									...
									<c:if test="${!empty list }">
										<c:forEach var="map" items="${list }">
											<tr class="align_center">
												<!-- 장바구니 -->
												<td>
												<form name="frmCart" method="post" action="<c:url value='/registration/open_registrationCart'/>">
													<input type="hidden" name="openSubCode"  value="${map['OPEN_SUB_CODE'] }">
													<input type="submit" id="btCart" value="장바구니" class="buttons">
												</form>
												</td>
												<!-- 년도 -->
												<td>
...
<!-- -------------------------------------------------------------여기서부터 장바구니---------------------------------------------------------------------  -->
						...
						<br><hr><h4 class="mt-4" style="background-color: white;">장바구니</h4> <br>
						<div class="table-wrapper-scroll-y my-custom-scrollbar">
							<table class="table table-bordered table-striped mb-0">
								<thead>
									<tr>
