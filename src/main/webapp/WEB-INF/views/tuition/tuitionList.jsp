...
<script type="text/javascript">
	...
	$(function() {
		...
		$('button[name=btTuition]').click(
				function() {
					open(
					'http://localhost:9091/every/tuition/tuitionPDF?tuitionNo='+$(this).val(),
					'chk',
					'width=1000,height=1000,left=0,top=0,location=yes,resizable=yes');
				});
	});
...
<div class="container-fluid px-4" style="background-color: white;">
		...
		<div class="card-body">
			<table border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td><input type="text" style="width: 50%"
						value="${map['STUDENT_ID']}" readonly></td>
	...
	<form name="frmTuition" method="post"
		action="<c:url value='/tuition/tuitionPDF'/>">
