...
--교수 샘플
Insert into EVERY.PROFESSOR (PROF_NO,POSITION_NO,DEPT_NO,PROF_NAME,PROF_ID,PROF_PWD,PROF_EMAIL,PROF_START_DATE,PROF_END_DATE,IDENTITY_STATE,IDENTITY_CODE,CHANGE_DATE) values ('1',1,27,'김교수','profkim','1',null,null,null,null,null,null);

--과목 샘플
Insert into EVERY.SUBJECT (SUBJ_CODE,PROF_NO,TYPE_CODE,SUBJ_NAME,CREDIT,PERSONNEL) values ('270001','1','1','웹프로그래밍',3,20);

--개설교과목 샘플
Insert into EVERY.OPEN_SUBJ (OPEN_SUB_CODE,SUBJ_CODE,PROF_NO,OPEN_DATE,CLOSE_DATE) values ('21270001','270001','1',to_date('21/03/02','RR/MM/DD'),to_date('21/06/28','RR/MM/DD'));

--학생 샘플
Insert into EVERY.STUDENT (STU_NO,STUDENT_ID,PWD,NAME,SEMESTER,MAJOR,MINOR,ADMISSION_DATE,GRADUATION_DATE,CREDITS,INDENTITY_STATE,INDENTITY_CODE,CHANGE_DATE,STATE,DEPT_NO) values ('201224026','rimkim','1','김영림','5','컴퓨터공학과','항공운항학과',null,null,null,null,null,null,'1',27);
